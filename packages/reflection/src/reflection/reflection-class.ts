import { databaseAnnotation } from './annotations.js';
import { applyMetadataOptions, classMetadata, classOptions } from './metadata-store.js';
import { allowsNull, allowsUndefined, normalizeTypeMetadata, resolveClassType, unwrapValueType } from './type-utils.js';
import {
    ReflectionKind,
    type ClassMetadata,
    type ClassType,
